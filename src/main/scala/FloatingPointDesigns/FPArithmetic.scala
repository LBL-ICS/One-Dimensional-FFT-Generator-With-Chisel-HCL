...
object FPArithmetic { // you might see errors from the IDE in the FP_adders, but you can ignore them
  ...
  // square root, less cycles less accurate
  class FP_sqrt(bw: Int) extends Module{
    require(bw == 16 || bw == 32 || bw == 64 || bw == 128)
    val io = IO(new Bundle{
      val in_a = Input(UInt(bw.W))
      val out_s = Output(UInt(bw.W))
    ...
    // multiply inverse square root approximation by input to get square root appx
    val multiplier4 = Module(new FP_multiplier(bw)) // one cycle
    multiplier4.io.in_a := io.in_a(bw - 1) ## multiplier3.io.out_s(bw - 2, 0)
    multiplier4.io.in_b := io.in_a
  ...
  class FP_sqrt2(bw: Int) extends Module {
    require(bw == 16 || bw == 32 || bw == 64 || bw == 128)
    val io = IO(new Bundle() {
      val in_a = Input(UInt(bw.W))
      val out_s = Output(UInt(bw.W))
    ...
    val result_reg_4 = RegInit(0.U(bw.W))
    result_reg_4 := result_reg_3
    ...
    val result_reg_5 = RegInit(0.U(bw.W))
    result_reg_5 := result_reg_4
    ...
    val half_input_reg_6 = RegInit(0.U(bw.W))
    half_input_reg_6 := half_input_reg_5
    val result_reg_6 = RegInit(0.U(bw.W))
    result_reg_6 := result_reg_5
    ...
    val half_input_reg_7 = RegInit(0.U(bw.W))
    half_input_reg_7 := half_input_reg_6
    val result_reg_7 = RegInit(0.U(bw.W))
    result_reg_7 := result_reg_6
    ...
    val half_input_reg_8 = RegInit(0.U(bw.W))
    half_input_reg_8 := half_input_reg_7
    val result_reg_8 = RegInit(0.U(bw.W))
    result_reg_8 := result_reg_7
    ...
    val half_input_reg_9 = RegInit(0.U(bw.W))
    half_input_reg_9 := half_input_reg_8
    val result_reg_9 = RegInit(0.U(bw.W))
    result_reg_9 := result_reg_8
    ...
    io.out_s := input_reg_9(bw - 1) ## multiplier4.io.out_s(bw - 2, 0) // total 5 cycles
  }
