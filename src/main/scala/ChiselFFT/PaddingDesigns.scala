...
//  class padding_hardware(sphere: Array[Int], elmnts_slice: Array[Int], segment_lengths: Array[Array[Int]], paddingLength: Int, streaming_width: Int, bw: Int) extends  Module{
//    val io = IO{new Bundle{
//      val in_en = Input(Bool())
////      val out_data_fs = Output(Vec(streaming_width, new ComplexNum(bw)))
////      val out_data_ss = Output(Vec(streaming_width, new ComplexNum(bw)))
//      val out_data = Output(Vec(streaming_width, new ComplexNum(bw)))
//      val out_valid = Output(Bool())
//    }}
...
//    val transposing_first_stage = Module(new transposing_stage(elmnts_slice(0), paddingLength, streaming_width, bw)).io
...
//    val transposing_second_stage = Module(new transposing_stage(elmnts_slice(1), paddingLength, streaming_width, bw)).io
//    val odpad_third_stage = Module(new one_dimensional_padding_streaming(paddingLength, streaming_width, segment_lengths(2), bw)).io
//
//    printf(p"sp_en: ${odpad_first_stage.in_en}")
//
//    sphere_rom.in_en := odpad_first_stage.out_en
//
//    odpad_first_stage.in_en := transposing_first_stage.out_start_cnt
//    odpad_first_stage.in_valid := sphere_rom.out_valid
//    odpad_first_stage.in := sphere_rom.out_data
//
//    transposing_first_stage.in_data := odpad_first_stage.out
//    transposing_first_stage.in_en := odpad_second_stage.out_en
//    transposing_first_stage.in_valid := odpad_first_stage.out_valid
//
//    odpad_second_stage.in := transposing_first_stage.out_data
//    odpad_second_stage.in_en := transposing_second_stage.out_start_cnt
//    odpad_second_stage.in_valid := odpad_first_stage.out_valid //transposing_first_stage.out_valid
//
//    transposing_second_stage.in_data := odpad_second_stage.out
//    transposing_second_stage.in_en := odpad_third_stage.out_en
//    transposing_second_stage.in_valid := odpad_second_stage.out_valid
//
//    odpad_third_stage.in := transposing_second_stage.out_data
//    odpad_third_stage.in_valid := odpad_second_stage.out_valid //transposing_second_stage.out_valid
//    odpad_third_stage.in_en := io.in_en
//
//    io.out_data := odpad_first_stage.out//odpad_third_stage.out
//    io.out_valid := odpad_first_stage.out_valid//odpad_third_stage.out_valid
//  }

//  class padding_hardware_test(sphere: Array[Int], elmnts_slice: Array[Int], segment_lengths: Array[Array[Int]], paddingLength: Int, streaming_width: Int, bw: Int) extends Module {
//    val io = IO {
//      new Bundle {
//        val in_en = Input(Bool())
//        //      val out_data_fs = Output(Vec(streaming_width, new ComplexNum(bw)))
...
//
//    odpad_second_stage.in := transposing_first_stage.out_data
//    odpad_second_stage.in_en := transposing_second_stage.out_start_cnt//io.in_en
...
//    odpad_third_stage.in_en := io.in_en
//
//    io.out_data := odpad_third_stage.out//transposing_second_stage.out_data//odpad_second_stage.out//transposing_first_stage.out_data//odpad_first_stage.out //odpad_third_stage.out
//    io.out_valid := odpad_third_stage.out_valid//transposing_second_stage.out_valid//odpad_second_stage.out_valid//transposing_first_stage.out_valid//odpad_first_stage.out_valid //odpad_third_stage.out_valid
//  }


//  class padding_hardware_test2(sphere: Array[Int], elmnts_slice: Array[Int], segment_lengths: Array[Array[Int]], paddingLength: Int, streaming_width: Int, bw: Int) extends Module {
//    val io = IO {
//      new Bundle {
//        val in_en = Input(Bool())
//        val out_data = Output(Vec(streaming_width, new ComplexNum(bw)))
...
//    odpad_third_stage.in_en := io.in_en
//
//    io.out_data := odpad_third_stage.out//transposing_first_stage.out_data//odpad_first_stage.out //odpad_third_stage.out
//    io.out_valid := odpad_third_stage.out_valid//transposing_first_stage.out_valid//odpad_first_stage.out_valid //odpad_third_stage.out_valid
//  }

//  class padding_hardware_test3(sphere: Array[Int], elmnts_slice: Array[Int], segment_lengths: Array[Array[Int]], paddingLength: Int, streaming_width: Int, bw: Int) extends Module {
//    val io = IO {
//      new Bundle {
//        val in_en = Input(Bool())
//        val out_data = Output(Vec(streaming_width, new ComplexNum(bw)))
...
//    sphere_rom.in_en := odpad_first_stage.out_en
//
//    odpad_first_stage.in_en := odfft_first_stage.out_strt_cnt
//    odpad_first_stage.in_valid := sphere_rom.out_valid
//    odpad_first_stage.in := sphere_rom.out_data
//
//    odfft_first_stage.in_en := transposing_first_stage.out_start_cnt
...
//
//    odpad_second_stage.in := transposing_first_stage.out_data
//    odpad_second_stage.in_en := odfft_second_stage.out_strt_cnt
//    odpad_second_stage.in_valid := transposing_first_stage.out_valid
//
//    odfft_second_stage.in_en := transposing_second_stage.out_start_cnt
...
//    odpad_third_stage.in := transposing_second_stage.out_data
//    odpad_third_stage.in_valid := transposing_second_stage.out_valid //transposing_second_stage.out_valid
//    odpad_third_stage.in_en := odfft_third_stage.out_strt_cnt
//
...
//
//    io.out_data := odfft_third_stage.out //transposing_first_stage.out_data//odpad_first_stage.out //odpad_third_stage.out
//    io.out_valid := odfft_third_stage.out_validate //transposing_first_stage.out_valid//odpad_first_stage.out_valid //odpad_third_stage.out_valid
//  }
